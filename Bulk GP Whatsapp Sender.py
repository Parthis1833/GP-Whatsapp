    ...
    def run(self):
        ...
        if csvPath is not None:
            ...
            if len(contactNumber) > 0:
                ...
                dict = {'name': name, 'mobile': mobile,'Message': message,'VAR2':None,'VAR3':None,'VAR4':None,'VAR5':None}
...
class Main(QtWidgets.QMainWindow):
    ...
    def __init__(self,parent=None):
        ...
        self.modeGroup.addButton(self.ui.messageWithExcleMessage)
        ...
        self.ui.messageWithExcleMessage.toggled.connect(self.onClickedMode)
    ...
    def open_csv_dialog(self):
        ...
        for index, row in data.iterrows():
            ...
            self.ui.tableWidget.setItem(index,cdx+3, QTableWidgetItem(str(row['message'])))
            self.ui.tableWidget.setItem(index,cdx+4, QTableWidgetItem(str(row['VAR1'])))
            self.ui.tableWidget.setItem(index,cdx+5, QTableWidgetItem(str(row['VAR2'])))
            self.ui.tableWidget.setItem(index,cdx+6, QTableWidgetItem(str(row['VAR3'])))
            self.ui.tableWidget.setItem(index,cdx+7, QTableWidgetItem(str(row['VAR4'])))
        # except:
    ...
    def onClickedMode(self):
        ...
        if radioBtn.isChecked():
            ...
            elif radioBtn.text() == "Message with Excel":
                choice = "Message with Excel"
                self.mediaController(True   )
                self.textController(False)
                self.hasLinkController(False)
    ...
    def parseTableData(self):
        ...
        columnList = ['status','name', 'mobile', 'message', 'VAR1', 'VAR2', 'VAR3', 'VAR4']
        data = pd.DataFrame(columns=['status','name', 'mobile', 'message', 'VAR1', 'VAR2', 'VAR3', 'VAR4']) 
